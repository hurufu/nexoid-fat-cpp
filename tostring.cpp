...
tostring(const enum CardholderMessage m) {
    switch (m) {
        ...
        case CRDHLDR_MSG_PLEASE_PRESENT_ONE_CARD_ONLY: return "CRDHLDR_MSG_PLEASE_PRESENT_ONE_CARD_ONLY";
        ...
        case CRDHLDR_MSG_SUPPLEMENTARY_AMOUNT_NOT_ALLOWED: return "CRDHLDR_MSG_SUPPLEMENTARY_AMOUNT_NOT_ALLOWED";
        case CRDHLDR_MSG_CASHBACK_NOT_ALLOWED: return "CRDHLDR_MSG_CASHBACK_NOT_ALLOWED";
        case CRDHLDR_MSG_CASHBACK_AMOUNT_TOO_HIGH: return "CRDHLDR_MSG_CASHBACK_AMOUNT_TOO_HIGH";
        case CRDHLDR_MSG_PAYMENT_AMOUNT_TOO_LOW_FOR_CASHBACK: return "CRDHLDR_MSG_PAYMENT_AMOUNT_TOO_LOW_FOR_CASHBACK";
        case CRDHLDR_MSG_TRANSACTION_AMOUNT_IS_OUT_OF_RANGE: return "CRDHLDR_MSG_TRANSACTION_AMOUNT_IS_OUT_OF_RANGE";
        ...
        case CRDHLDR_SRC_STATUS: return "CRDHLDR_SRC_STATUS";
        ...
        case CRDHLDR_DBG_MISSING_PARAMETERS: return "CRDHLDR_DBG_MISSING_PARAMETERS";
    }
